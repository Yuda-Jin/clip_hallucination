...
run_finetune "clip_finetune_mix_contrastive_1e-5_3_margin_all_0.2_0.2" "openai/clip-vit-large-patch14-336" \
"OHD-Caps/train/coco_annotations_8k.json" "OHD-Caps/dev/dev_data.json" "3" "1e-5" "0.2" "0.2"